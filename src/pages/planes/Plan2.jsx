    ...
    <div className="page">
      <section className="page-section">
        <div className="page-header">
          <h1 className="page-title">Plan 2: Sitio Profesional (Frontend + Backend + Base de Datos)</h1>
        ...
        <div className="page-content">
          <div className="content-card">
            <h2>¿Qué incluye?</h2>
            <p style={{ marginBottom: '1rem' }}><strong>Todo lo del plan frontend + funcionalidades avanzadas:</strong></p>
            <ul className="feature-list">
              <li><strong>Backend y base de datos:</strong>
              ...
              <li><strong>Integraciones:</strong>
                <ul style={{ marginTop: '0.5rem', marginLeft: '1.5rem' }}>
                  <li>WhatsApp</li>
                  <li>Google Maps</li>
                  <li>Correo SMTP (para formularios reales)</li>
                  <li>Formularios conectados a base de datos</li>
                  <li>Envío de mensajes automáticos o notificaciones (si aplica)</li>
                </ul>
              </li>
            </ul>
          </div>
          ...
          <div className="content-card">
            ...
            <div style={{ marginBottom: '1rem' }}>
              <p><strong>Precio de lista:</strong> <span style={{ fontSize: '1.5rem', color: '#4A90E2' }}>$18,200</span></p>
              <p><strong>Descuento 30%:</strong></p>
              <p style={{ fontSize: '2rem', color: '#4A90E2', fontWeight: 'bold', margin: '0.5rem 0' }}>$14,000</p>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginTop: '1.5rem' }}>
              <div style={{ border: '1px solid #4A90E2', padding: '1rem', borderRadius: '8px' }}>
                <h3 style={{ marginTop: 0 }}>PAGO 1</h3>
                <p>Anticipo del 50%</p>
                <p style={{ fontSize: '1.5rem', color: '#4A90E2', fontWeight: 'bold' }}>$7,000</p>
              </div>
              <div style={{ border: '1px solid #4A90E2', padding: '1rem', borderRadius: '8px' }}>
          ...
          <div className="content-card">
            ...
            <ul className="feature-list">
              ...
              <li>Para comenzar se necesita INE y constancia de situación fiscal (en caso de requerir factura)</li>
