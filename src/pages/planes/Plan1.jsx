    ...
    <div className="page">
      <section className="page-section">
        <div className="page-header">
          <h1 className="page-title">Plan 1: Landing Extendida (Frontend 5 páginas)</h1>
        ...
        <div className="page-content">
          <div className="content-card">
            ...
            <ul className="feature-list">
              <li><strong>Diseño completo de 5 páginas:</strong>
              ...
              <li><strong>Integración de:</strong>
                <ul style={{ marginTop: '0.5rem', marginLeft: '1.5rem' }}>
                  <li>WhatsApp</li>
                  <li>Google Maps</li>
          ...
          <div className="content-card">
            ...
            <div style={{ marginBottom: '1rem' }}>
              <p><strong>Precio de lista:</strong> <span style={{ fontSize: '1.5rem', color: '#4A90E2' }}>$11,700</span></p>
              <p><strong>Descuento 30%:</strong></p>
              <p style={{ fontSize: '2rem', color: '#4A90E2', fontWeight: 'bold', margin: '0.5rem 0' }}>$9,000</p>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem', marginTop: '1.5rem' }}>
              <div style={{ border: '1px solid #4A90E2', padding: '1rem', borderRadius: '8px' }}>
                <h3 style={{ marginTop: 0 }}>PAGO 1</h3>
                <p>Anticipo del 50%</p>
                <p style={{ fontSize: '1.5rem', color: '#4A90E2', fontWeight: 'bold' }}>$4,500</p>
              </div>
              <div style={{ border: '1px solid #4A90E2', padding: '1rem', borderRadius: '8px' }}>
