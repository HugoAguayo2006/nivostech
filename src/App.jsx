...
function App() {
  ...
  const prevSlide = () => {
    setCurrent((prev) => (prev === 0 ? projectImages.length - 1 : prev - 1));
  };

  const nextSlide = () => {
    setCurrent((prev) => (prev === projectImages.length - 1 ? 0 : prev + 1));
  };
    ...
    <div className="hero-media">
      ...
      <section id="proyectos" className="projects">
        ...
        <p className="section-subtitle">
          Algunos de los sitios y prototipos web que hemos desarrollado.
        </p>
        ...
        <p className="carousel-caption">
          Proyecto {current + 1} de {projectImages.length}
        </p>
      </section> */}
